...
class Frame_Box:
	def __init__(self,main):
		...
		self.configure()
		self.place()
		kernel.set_Node("Region_file","Node_handleStart",None)

	def close(self):
		kernel.set_Node("Region_file","Node_handleStop",None)
		None
	...
	def configure(self):
		...
		def btn_sw():
			global b
			b = 1 - b
			kernel.set_Node(macro.Region_file,macro.Node_file_handlewriteData,b)
			
		self.btnText_Resume.configure(command=btn_sw)
