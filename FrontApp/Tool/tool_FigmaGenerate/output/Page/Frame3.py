...
class Frame_Box:
	...
	def setup(self):
		...
		self.image_btnImage2_exit = ImageTk.PhotoImage(Image.open(pathlib.Path(os.path.join(os.path.dirname(__file__),'..','Asset','Frame3','btnImage2_exit.png')).as_posix()).resize((24.0,24.0)))
		self.btnImage2_back=tk.Label(self.frameBox)
		self.image_btnImage2_back = ImageTk.PhotoImage(Image.open(pathlib.Path(os.path.join(os.path.dirname(__file__),'..','Asset','Frame3','btnImage2_back.png')).as_posix()).resize((20.0,20.0)))
		self.btnImage2_next=tk.Label(self.frameBox)
		self.image_btnImage2_next = ImageTk.PhotoImage(Image.open(pathlib.Path(os.path.join(os.path.dirname(__file__),'..','Asset','Frame3','btnImage2_next.png')).as_posix()).resize((20.0,20.0)))
		self.btnImage2_home=tk.Label(self.frameBox)
		self.image_btnImage2_home = ImageTk.PhotoImage(Image.open(pathlib.Path(os.path.join(os.path.dirname(__file__),'..','Asset','Frame3','btnImage2_home.png')).as_posix()).resize((30.0,30.0)))
		None
